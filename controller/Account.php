...
<div class="container mt-4">
    <div class="row">
<div class="col-md-6">
<h1 class="my-4">Harsha Fashion</h1>
...
<div class="col-md-6">
<img src="assets/Frame 160.png" alt="Banner Image" class="img-fluid">
</div>
</div>
        </div>
...
<div class="container mt-5">
    ...
    <div class="row">
        <div class="col-md-8">
            <form>
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="frock"/>
                </div>
        ...
        <div class="col-md-4">
        <p class="text-end text-danger mt-2">50 products added.</p>
            <div class="preview-container">
                <div id="imagePreview" style="background-color: #ddd; height: 150px; display: flex; align-items: center; justify-content: center;">
                <div class="col-md-6">
<img src="assets/frock.png" alt="Banner Image" class="img-fluid">
</div>
                </div>
                <p><strong>Fock</strong></p>
